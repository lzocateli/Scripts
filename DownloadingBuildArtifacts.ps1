########################################################################################
## Faz download do arquivo zip de artefatos do servidor de Build, depois descompacta o
## arquivo na pasta de destino local.
########################################################################################
[CmdletBinding()]
...
param(
    ...
    if ($appendBuildNumberVersion)
    {
        ...
        Write-Verbose -Verbose ('BuildVersion: ' + $versionData)
